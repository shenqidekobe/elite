...
<#--右边的操作区-->
    ...
    <div class="process">
        ...
        <p class="process-title" style="left:168px;">需求梳理</p>
        <p class="process-title" style="left:318px;">界面设计</p>
        <p class="process-title" style="left:470px;">开发测试</p>
        <p class="process-title" style="left:616px;">交付上线</p>
    ...
    <div style="margin-top:40px;">
            ...
            <div style="padding:20px;position: relative;">
                ...
                <div class="status-to-opt">
                    ...
                    <div style="text-align: center;margin-top:20px;">
                        ...
                        <div><button type="button" class="opt-btn">去竞标</button></div>
        ...
        <div class="project-intro">
        	<div class="reference">
				<p>參考項目：<a href="#">www.yunyinghui.com</a></p>
				<p>聯繫人：<span>Tom</span>&nbsp;<span>13671575128</span></p>
			</div>
