...
<body class="skin-blue">
						...
						<form id="listForm" method="POST">
							<div class="box-header">
								<div class="input-group"
									...
									"${company.memberId}" id="memberId"/>
									<input type="hidden" name="chargeId" value=
									"${company.chargeId}" id="chargeId"/>
									<input type="hidden" name="chargeName" value="" id="name"/>
									 <span
								...
								<button type="button" class="btn btn-primary" id="search"
									...
									<label id="show_result">
										<c:if test="${company.chargeId!=null }">
											已经分配：${chargeName}
										</c:if>
									</label>
							</div>
	...
	<script src="${_PATH}/res/js/admin/channel/company/allot.js"></script>
