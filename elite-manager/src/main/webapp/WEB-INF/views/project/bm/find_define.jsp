			...
			<section class="content">
				<div class="box">
					<button type="button" class="btn btn-primary"
						style="margin: 10px 0 10px 10px;" id="backDefine">返回列表</button>
					<div class="box-header">
						<h3 class="box-title">查看立项书</h3>
					</div>
					<!-- /.box-header -->
					<table
						...
						<div class="send-project box-body">
							...
							<div class="sp-item">
								<label class="title-style2">研发费用 : </label> <input type="text"
									style="width: 170px;" class="short-input1"
									value="${define.totalAmount}" name="totalAmount"
									readonly="readonly"></input> <span>元</span>
							</div>
							<div class="sp-item">
								<label class="title-style2">股权 : </label> <input type="text"
									class="short-input1" value="${define.stock*100}" name="stock"
									readonly="readonly"></input> <span>%</span>
							</div>
							<div class="sp-item">
								...
								<table class="sp-table">
									...
									<c:forEach items="${define.stages}" var="stage">
										<tr style="text-align: center;">
											...
											<td><fmt:formatDate value="${stage.startTime}"
													pattern="yyyy-MM-dd" /> &nbsp;-&nbsp; <fmt:formatDate
													value="${stage.originalStopTime}" pattern="yyyy-MM-dd" />
							...
							<div class="sp-item">
								<label class="title-style2">期望交付时间 : </label> <input type="text"
									class="short-input2"
									value="<fmt:formatDate value='${define.deliveryTime}' pattern='yyyy-MM-dd' />"
							...
							<div class="sp-item">
								...
								<div style="margin-top: 10px;">
									...
									<div style="margin-top: 10px;">
										...
										${define.atta.fileName} <a href="${define.atta.downPath}"
