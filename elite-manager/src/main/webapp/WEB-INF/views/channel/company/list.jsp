...
<body class="skin-blue">
						...
						<form id="listForm">
							<div class="box-header">
								<div class="input-group"
									style="width: 220px; margin-left: 10px; float: left;">
									 <input type="text"
										name="keyword" id="keywordId" class="form-control" placeholder="用户名/姓名/渠道编号/手机号">
								</div>
							<div class="input-group" style="width: 220px; float: left;">
								...
								<button type="button" class="btn btn-primary"
									style="margin-left: 50px; float: left;" id="search">搜索</button>
							</div>
	...
	<script src="${_PATH}/res/js/admin/channel/company/list.js"></script>
