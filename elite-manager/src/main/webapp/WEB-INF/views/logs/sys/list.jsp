...
<body class="skin-blue">
	...
	<script src="${_PATH}/res/js/admin/logs/sys/list.js"></script>
						...
						<table class="table table-bordered">
							<tbody>
								<tr style="text-align: center;">
									...
									<th style="width: 65%" id="detailLoginName"></th>
								</tr>
								<tr style="text-align: center;">
								...
								<tr style="text-align: center;">
									...
									<th style="width: 65%;word-break:break-all" id="detailContent"></th>
								</tr>
								<tr style="text-align: center;">
