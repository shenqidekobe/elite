	    ...
	    <div class="form-box">
		        ...
		        <form class="row form-group form-horizontal" role="form" id="project-form1">
		        	<div class="selectChannel">
		        	    <input type="hidden"  id="selectChannelValId">
		        		<ul id="selectChannelId">
		        			<li class="default_select" style="margin-right:60px;" data="partnerCompany">我有项目推荐</li>
		        			<li class="default_select" data="partnerElite">我有人才推荐</li>
		        		</ul>
		        	</div>
		            ...
		            <div class="next-step">
		                ...
		                <div class="loginDiv">已有账户？<a href="${_PATH}/login?ts=${RequestParameters["ts"]}">立即登录</a></div>
		            </div>
		        </form>
		    </div>
	</div>
...
<!--项目推荐方-资料完善-->
    ...
    <@block name="script">
    <script  src="${_PATH}/res/script/myjs/member/partner/register.js"></script>
