<@extend name="layout">
    ...
    <link type="text/css" rel="stylesheet" href="${_PATH}/res/style/css/register/partnerElite_register.css"/>
    </@block>
    <@block name="body">
    <#--头部-->
	...
	<!-- 项目方注册首页 >
	<!--项目推荐方-资料完善-->
	<div id="partnerElite_register">
	<div class="recommend-form-box">
	<div class="recommend-form" id="personnelStep1" style="height:700px">
	    <div class="form-box">
		        <div class="title">简单几步，完成人才渠道方注册</div>
		        <div class="hr-line"></div>
	
		        <form class="row form-group form-horizontal" role="form" id="project-form1">
		        	
		        	<div class="form-group form-grp" style="padding-top:15px;">
		                <div class="col-xs-7 col-md-7 form-group-cent">
		                    <input class="form-control group-cent-inpt" type="text"  name="inviteCode" id="inviteCodeId" placeholder="推荐人手机号或邀请码" style="width:400px;" maxlength="20">
		                </div>
		            </div>
	
		            <div class="form-group form-grp">
		                <div class="col-xs-7 col-md-7 form-group-cent">
		                    <input class="form-control group-cent-inpt" type="text" id="nickName" name="nickName" placeholder="请输入用户名" autocomplete="off" style="width:400px;" maxlength="20">
		                </div>
		            </div>
		            <div class="form-group form-grp">
		                <div class="col-xs-7 col-md-7 form-group-cent">
		            ...
		            <div class="form-group form-grp" style="padding-left:63px">
		                <div class="col-xs-7 col-md-7 form-group-cent">
		            ...
		            <div class="form-group">
		                <div class="col-xs-9 col-md-9 col-md-offset-3" style="padding-left:0; margin-left:10px">
		                    <label class="checkbox-inline">
		                        <input type="checkbox" id="inlineCheckbox" value="1" checked>
		                        <span class="agree">我已阅读并同意<a href="${_PATH}/protocol/user" target="_blank">《猎头注册协议》</a></span>
		                    </label>
		                </div>
		            </div>
		            <div class="next-step">
    ...
    <@block name="script">
       <script  src="${_PATH}/res/script/myjs/member/partnerElite/register.js"></script>
    </@block>
</@extend>