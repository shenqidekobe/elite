        ...
        <div<#if id!=''> id="${id}"</#if> class="ym-pagination">
            <ul>
                <li class="prev <#if page == 1>disabled</#if>"  >
                    <a href="<#if page == 1>javascript:;<#else>${url(path, params+{"page":page-1, "pagesize": pagesize})}</#if>"><i class="ico ico-page-prev"></i>上一页</a>
                </li>
            <#-- maxpage <= 5 -->
                <#if maxpage lt 6>
                <#-- page=1 -->
                ...
                <#if maxpage gt 1>
                    <li class="next <#if page == maxpage>disabled</#if>">
                        <a href="<#if page == maxpage>javascript:;><#else>${url(path, params+{"page":page+1, "pagesize": pagesize})}</#if>">下一页<i class="ico ico-page-next"></i></a>
                    </li>
                </#if>
            </ul>
