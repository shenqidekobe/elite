	...
	<div class="modal-dialog" role="document">
		<div class="box box-success">
			<div class="box-header">
				<h3 class="box-title">您将要对此项目添加备注</h3>
			...
			<div style="margin-left: 15px; margin-right: 15px;">
				...
				<input type="hidden" name="type" id="remarksTypeId" value="${type}"/>
						...
						<p class="message">
						    ...
						    <div>
						        ...
						        <span style="margin-left:320px;">${record.realName}添加</span>
						           ...
						           内容：
							<div data="${record.id}">
							    <shiro:hasPermission name="elite:settlement:receivable:removeRemarks">
								<button type="button" class="text-muted pull-right"
									id="removeWorkRecord">删除</button>
							  </shiro:hasPermission>
								<shiro:hasPermission name="elite:settlement:receivable:updateRemarks">
									<button type="button" class="text-muted pull-right" id="eliteWorkRecord">编辑</button>
								</shiro:hasPermission>
								<button type="button" class="text-muted pull-right"
