...
<body class="skin-blue">
					...
					<div class="box">
						...
						<form id="listForm" method="POST">
						  <div style="float: left; margin-left: 0px; width: 205px">
								...
								<div class="input-group" style="width: 200px; float: left;">
									<input style='display: none' /> <span class="input-group-addon">支付类型</span>
									<select
											class="form-control"  id="payType" name="payType">
											<option value="">----请选择----</option>
											<c:forEach items="${payType}" var="type">
											<option value="${type}">${type.label}</option>
											</c:forEach>
								   </select>
								</div>
	...
	<!-- ./wrapper -->
	<script src="${_PATH}/res/js/admin/settlement/inorder/list.js"></script>
</body>
</html>