 <#if toplist?size lt 1>
   ...
   <input type="hidden" value="${ranking}" id="rankingId">
                            ...
                            <div class="precedenceTable">
                                <h2><font size="2"><span >用户名</span><span>总收益</span><span>推荐精英</span><span>推荐渠道</span></font></h2>
                                <ul id="table_ul" class="table_ul">
                                 <#if list?size lt 1>
	暂无数据
	</#if>
    <#list list as it>
	  <li>
        ...
        <div class="li_head">
          <#if it.memberBasic.photoId??>
            <img src="${it.basic.memberBasic.memberPhoto.path}">   
          <#else>
              <img src="${_PATH}/res/images/default.jpg" >
           </#if>
        </div>
