...
<body class="skin-blue">
				...
				<div class="col-md-12" style="min-width: 950px;">
					<div class="box">
						<div class="box-header">
							<h3 class="box-title">精英管理</h3>
						</div>
						<form id="listForm" action="${_PATH}/member/elite/listData">
							<div class="box-header">
							<input style='display:none' />
								<div class="input-group"
									style="width: 260px; margin-left: 10px; float: left;">
									<span class="input-group-addon">模糊搜索</span> <input type="text"
										class="form-control" name="keyword" id="keywordId" placeholder="名称、编号、会员账号">
								</div>
	...
	<script src="${_PATH}/res/js/admin/member/elite/close.js"></script>
	<script src="${_PATH}/res/js/admin/member/elite/level.js"></script>
	<script src="${_PATH}/res/js/admin/member/elite/list.js"></script>
