...
import com.ledao.elite.core.framework.plugin.pay.pingpp.PingBankCode;
...
public class BankUtils {  
    ...
    public static void main(String[] args)throws Exception {  
        String cardNumber = "6217992900012379173";//卡号  
        String name = getNameOfBank(cardNumber);  
        String code = getBankCode(cardNumber);  
        System.out.println(name+"   "+code);
    }  
    
    //获取银行的code，对应ping++的code
    public static String getBankCode(String idCard){
    	String name = getNameOfBank(idCard); 
    	PingBankCode[] pbc=PingBankCode.values();
    	for(PingBankCode c:pbc){
    		if(name.startsWith(c.desc)){
    			return c.code;
    		}
    	}
    	return "";
