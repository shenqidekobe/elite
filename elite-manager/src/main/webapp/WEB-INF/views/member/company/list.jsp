...
<body class="skin-blue">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
							...
							<div class="box-header">
								<div class="input-group"
									...
									<input style='display: none' /> <span
										...
										class="form-control" name="keyword" id="keywordId" placeholder="称呼、编号、会员账号">
								</div>
		...
		<!-- /.right-side -->
		<form id="detailForm" action="${_PATH}/member/company/detail"
	...
	<script src="${_PATH}/res/js/admin/member/company/list.js"></script>
